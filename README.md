# ABLE dmspreview app for file detail page

This app expands the preview for files ("Akten") to a more readable format. At this stage only avaiable for personal files, but should get configurable for other files.
